        ...
        <div class="pb-sidebar">
            ...
            <?php if (strstr(get_locale(), 'de')): ?>
                <div class="pb-support-box">
                    ...
                    <p>
                        <a href="https://wordpress-kurs.pascal-bajorat.com/" class="button"
            ...
            <div class="pb-support-box">
                ...
                <p>
                    <a href="<?php echo esc_url(__('https://www.pascal-bajorat.com/en/lp/wordpress-performance-optimization/', 'pb-seo-friendly-images')); ?>" class="button"
