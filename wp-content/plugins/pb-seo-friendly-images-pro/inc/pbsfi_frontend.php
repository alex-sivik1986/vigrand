...
class pbsfi_frontend
{
	...
	public function initialize()
	{
		...
		if( $this->pbSEOFriendlyImages->settings['optimize_img'] == 'all' || $this->pbSEOFriendlyImages->settings['optimize_img'] == 'thumbs' ) {
			add_filter( 'wp_get_attachment_image_attributes', [ $this, 'optimize_image_attributes' ], 10, 2 );
		}

		// process post images
		if( $this->pbSEOFriendlyImages->settings['optimize_img'] == 'all' || $this->pbSEOFriendlyImages->settings['optimize_img'] == 'post' ) {
