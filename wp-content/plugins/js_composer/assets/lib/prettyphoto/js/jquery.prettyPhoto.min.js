    ...
    $.fn.prettyPhoto = function(pp_settings) {
        ...
        function _fitToViewport(width, height) {
            if (resized = !1, _getDimensions(width, height), imageWidth = width, imageHeight = height, (windowWidth < pp_containerWidth || windowHeight < pp_containerHeight) && doresize && settings.allow_resize && !percentBased) {
                for (resized = !0, fitting = !1; !fitting;) windowWidth < pp_containerWidth ? (imageWidth = windowWidth - 60, imageHeight = height / width * imageWidth) : windowHeight < pp_containerHeight ? (imageHeight = windowHeight - 60, imageWidth = width / height * imageHeight) : fitting = !0, pp_containerHeight = imageHeight, pp_containerWidth = imageWidth;
