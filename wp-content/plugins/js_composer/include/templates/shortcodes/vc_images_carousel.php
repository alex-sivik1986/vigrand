...
$slides_wrap_start = '';
$slides_wrap_end = '';
$pretty_rand = 'link_image' === $onclick ? ' data-rel="prettyPhoto"' : '';
...
$class_to_filter = 'wpb_images_carousel wpb_content_element vc_clearfix vc_custominfiniteloop';
				...
				<div class="vc_carousel-slideline">
					<div class="vc_carousel-slideline-inner">
						<?php foreach ( $images as $attach_id ) :  ?>
							...
							$image_attributes = wp_prepare_attachment_for_js( $attach_id );
								...
								<div class="vc_inner">
									...
									<?php elseif ( 'custom_link' === $onclick && isset( $custom_links[ $i ] ) && '' !== $custom_links[ $i ] ) :  ?>
										<a href="<?php echo $custom_links[ $i ] ?>"<?php echo( ! empty( $custom_links_target ) ? ' target="' . $custom_links_target . '"' : '' ) ?>>
											<?php echo $thumbnail ?>
											<span class="carousel-text"><?php echo $image_attributes['title'] ?></span>
										</a>
									<?php else : ?>
										<?php echo $thumbnail ?>
									<?php endif ?>
