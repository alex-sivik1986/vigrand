...
jQuery(document).ready(function($) {
    ...
    jQuery('a.cf7d-edit-value').click(function(event) {
	   ...
	   jQuery('#cf7d-modal-form-edit-value').removeClass('loading');
		...
		var arr_option = ['radio','checkbox','select','hidden'];
        ...
        .done(function(data) {
			...
			jQuery.each(json, function(index, el){
				...
				if(index in arr_field_type){
					...
					else if(arr_field_type[index]['basetype'] == 'dynamictext' || arr_field_type[index]['basetype'] == 'dynamichidden' || arr_field_type[index]['basetype'] == 'text' || arr_field_type[index]['basetype'] == 'email'  || arr_field_type[index]['basetype'] == 'url'|| arr_field_type[index]['basetype'] == 'tel' || arr_field_type[index]['basetype'] == 'URL' || arr_field_type[index]['basetype'] == 'hidden' || arr_field_type[index]['basetype'] == 'number' || arr_field_type[index]['basetype'] == 'date' || arr_field_type[index]['basetype'] == 'acceptance' || arr_field_type[index]['basetype'] == 'quiz' ){
