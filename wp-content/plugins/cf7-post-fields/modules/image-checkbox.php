        ...
        public function wpcf7_post_image_checkbox_shortcode_handler( $tag )
        {
            ...
            foreach ( $values as $key => $value )
            {
                ...
                if(get_post_status($ids[$key]) !== false)
                {
                    ...
                    $item = sprintf('<label class="wpcf7-list-item-media %5$s">%2$s<input %3$s /></label><div class="wpcf7-list-item-body"><div class="wpcf7-list-item-label">%1$s</div><div class="wpcf7-list-item-excerpt">%4$s</div><div class="wpcf7-list-item-content">%6$s</div></div>',
                        esc_html( $label ),
						$image_html,
                        $item_atts,
                        $excerpt,
