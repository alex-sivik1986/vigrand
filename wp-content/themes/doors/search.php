<?php get_header();?>
  ...
  <section class="titlebar ">
    <div class="row">
      ...
      <div>
        <h1 id="page-title" class="title"><?php printf( esc_html__( 'Search Results for: %s', 'doors' ), get_search_query() ); ?></h1>
      </div>
    </div>
  </section>
...
<main class="row l-main">
		<div class="large-9 main columns">
			...
			<header class="page-header">
				<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'doors' ); ?></h1>
			</header>
				 <p> <?php esc_html_e('It seems we cant find what youre looking for. Perhaps searching can help.','doors') ?></p>
			<?php
			endif;
