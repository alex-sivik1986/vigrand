...
add_action( 'tgmpa_register', 'doors_register_required_plugins' );
 ...
 */
function doors_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			...
			'slug'      => 'revslider',
			'source'      => 'http://themes.webdevia.com/plugins/revslider.zip',
			'required'      => false,
			'version'     => '5.4.5.2',
    ...
    array(
      ...
      'force_activation'    => false,
		...
		array(
			'name'      => 'wd main plugin', // The plugin name
			'slug'      => 'wd-main-plugin', // The plugin slug (typically the folder name)
			'source'      => get_stylesheet_directory() . '/inc/plugins/lib/plugins/wd-main-plugin.zip', // The plugin source
			'required'      => false, // If false, the plugin is only 'recommended' instead of required
