<?php
class doors_add_button {

    var $pluginname = 'wd-shortcode';
    var $path = '';
    var $internalVersion = 200;
    /**
     * doors_add_button::doors_add_button()
     * the constructor
     *
     * @return void
     */
    function doors_add_button() {
    ...
    /**
     * doors_add_button::register_button()
    ...
    /**
     * doors_add_button::add_tinymce_plugin()
    ...
    /**
     * doors_add_button::change_tinymce_version()
...
// Call it now
$tinymce_button = new doors_add_button();
?>