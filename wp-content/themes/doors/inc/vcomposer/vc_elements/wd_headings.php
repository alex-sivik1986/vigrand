...
vc_map( array(
  ...
  "params" => array(
    ...
    array(
      ...
      "param_name" => "doors_heading_font_family",
    ...
    array(
      ...
      "param_name"   =>   "doors_heading_font_style",
      'value' => array(
    ...
    array(
      ...
      "param_name"   =>   "doors_heading_font_weight",
      'value' => array(
    ...
    array(
      ...
      "param_name" => "doors_heading_font_size",
      "min" => 14,
      "suffix" => "px",
      "group" => "Typography",
    ),
    array(
      ...
      "param_name" => "doors_heading_color",
      "value" => "",
      "group" => "Typography",
    ),
    array(
      ...
      "param_name" => "doors_heading_text_transform",
      'value' => array(
    ...
    array(
      ...
      "param_name" => "doors_heading_line_height",
      "value" => "",
      "suffix" => "px",
      "group" => "Typography"
    ),
    array(
      ...
      "param_name" => "doors_heading_letter_spacing",
      "value" => "",
      "suffix" => "px",
      "group" => "Typography"
    ),
    ...
    array(
      ...
      'value' => $doors_fonts_array,
      "heading" => esc_html__("Font Family", 'doors'),
      "param_name" => "doors_sub_heading_font_family",
      "group" => "Typography",
    ),
    array(
      "type" => "dropdown",
      "heading"           =>   esc_html__("Font Style", 'doors'),
      "param_name"   =>   "doors_sub_heading_font_style",
      'value' => array(
        esc_html__('Normal', 'doors')  =>   'normal',
        esc_html__('Italic','doors')        =>   'italic',
        esc_html__('Inherit','doors')       =>   'inherit',
    ...
    array(
      "type" => "dropdown",
      "heading"           =>   esc_html__("Font Weight", 'doors'),
      "param_name"   =>   "doors_sub_heading_font_weight",
      'value' => array(
        esc_html__('Default', 'doors') =>   '400',
        '100'     =>   '100',
        '200'     =>   '200',
    ...
    array(
      ...
      "class" => "",
      "heading" => esc_html__("Font Size", 'doors'),
      "param_name" => "doors_sub_heading_font_size",
      "min" => 14,
      "suffix" => "px",
      "group" => "Typography",
    ),
    array(
      ...
      "class" => "",
      "heading" => esc_html__("Font Color", 'doors'),
      "param_name" => "doors_sub_heading_color",
      "value" => "",
      "group" => "Typography",
    ),
    array(
      "type" => "dropdown",
      "heading" => esc_html__("Text Transform", 'doors'),
      "param_name" => "doors_sub_heading_text_transform",
      'value' => array(
        esc_html__('Default', 'doors') =>   'None',
        'lowercase'    =>   'Lowercase',
        'uppercase'    =>   'Uppercase',
    ...
    array(
      ...
      "class" => "",
      "heading" => esc_html__("Line Height", 'doors'),
      "param_name" => "doors_sub_heading_line_height",
      "value" => "",
      "suffix" => "px",
      "group" => "Typography"
    ),
    array(
      ...
      "class" => "",
      "heading" => esc_html__("Letter spacing", 'doors'),
      "param_name" => "doors_sub_heading_letter_spacing",
      "value" => "",
      "suffix" => "px",
      "group" => "Typography"
    ),
