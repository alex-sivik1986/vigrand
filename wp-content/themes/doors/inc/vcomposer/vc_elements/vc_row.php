...
vc_add_param("vc_row", array(
	...
	"param_name" => "doors_row_delimiter_style",
...
vc_add_param("vc_row", array(
	...
	"param_name" => "doors_row_delimiter_height",
	"dependency" => Array("element" => "doors_row_delimiter_style",
...
vc_add_param("vc_row", array(
	...
	"param_name" => "doors_row_delimiter_color",
	"value" => "#bbb",
	"dependency" => Array("element" => "doors_row_delimiter_style",
	                      "value" => array('vertical_line_bottom_center',
										                     'vertical_line_bottom_right',
