...
vc_map( array(
  ...
  "params" => array(
    ...
    array(
      ...
      "dependency" => Array("element" => "doors_blog_type", "value" => array('doors_one_post')),
      "dependency" => Array("element" => "doors_blog_affichage_one_post", "value" => array('doors_blog_Post_from_list')),
    ),
    array(
      "type" => "dropdown",
    ...
    array(
      ...
      "dependency" => Array("element" => "doors_blog_affichage_type", "value" => array('doors_blog_image_left','doors_multi_post')),
    ),
    array(
      "type" => "checkbox",
      "heading" => esc_html__("Display Pagination", 'petroleum'),
