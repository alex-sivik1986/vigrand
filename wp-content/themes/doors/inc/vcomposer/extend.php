...
$doors_fonts_array = unserialize($fontsSeraliazed);
...
$vc_add_css_animation = array(
	'type' => 'dropdown',
	'heading' => esc_html__( 'CSS Animation', 'doors' ),
	'param_name' => 'css_animation',
	'admin_label' => true,
	'value' => array(
		  esc_html__( 'No', 'doors' ) => '',
		  esc_html__('Bounce In', 'doors' ) => 'bounceIn',
          esc_html__('Bounce In Down', 'doors' ) => 'bounceInDown',
          esc_html__('Bounce In Left', 'doors' ) => 'bounceInLeft',
          esc_html__('Bounce In Right', 'doors' ) => 'bounceInRight',
          esc_html__('Bounce In Up', 'doors' ) => 'bounceInUp',
          esc_html__('Fade In', 'doors' ) => 'fadeIn',
          esc_html__('Fade In Down', 'doors' ) => 'fadeInDown',
          esc_html__('Fade In Down Big', 'doors' ) => 'fadeInDownBig',
          esc_html__('Fade In Left', 'doors' ) => 'fadeInLeft',
          esc_html__('Fade In Left Big', 'doors' ) => 'fadeInLeftBig',
          esc_html__('Fade In Right', 'doors' ) => 'fadeInRight',
          esc_html__('Fade In Right Big', 'doors' ) => 'fadeInRightBig',
          esc_html__('Fade In Up', 'doors' ) => 'fadeInUp',
          esc_html__('Fade In Up Big', 'doors' ) => 'fadeInUpBig',
          esc_html__('Flip', 'doors' ) => 'flip',
          esc_html__('Flip In X', 'doors' ) => 'flipInX',
          esc_html__('Flip In Y', 'doors' ) => 'flipInY',
          esc_html__('Flip Out X', 'doors' ) => 'flipOutX',
          esc_html__('Flip Out Y', 'doors' ) => 'flipOutY',
          esc_html__('Light Speed In', 'doors' ) => 'lightSpeedIn',
          esc_html__('Light Speed Out', 'doors' ) => 'lightSpeedOut',
          esc_html__('Rotate In', 'doors' ) => 'rotateIn',
          esc_html__('Rotate In Down Left', 'doors' ) => 'rotateInDownLeft',
          esc_html__('Rotate In Down Right', 'doors' ) => 'rotateInDownRight',
          esc_html__('Rotate In Up Left', 'doors' ) => 'rotateInUpLeft',
          esc_html__('Rotate In Up Right', 'doors' ) => 'rotateInUpRight',
          esc_html__('Slide In Up', 'doors' ) => 'slideInUp',
          esc_html__('Slide In Down', 'doors' ) => 'slideInDown',
          esc_html__('Slide In Left', 'doors' ) => 'slideInLeft',
          esc_html__('Slide In Right', 'doors' ) => 'slideInRight',
          esc_html__('Zoom In ', 'doors' ) => 'zoomIn',
          esc_html__('Zoom In Down', 'doors' ) => 'zoomInDown',
          esc_html__('Zoom In Left', 'doors' ) => 'zoomInLeft',
          esc_html__('Zoom In Right', 'doors' ) => 'zoomInRight',
          esc_html__('Zoom In Up', 'doors' ) => 'zoomInUp',
          esc_html__('Roll In', 'doors' ) => 'rollIn',
	),
	'description' => esc_html__( 'Select type of animation for element to be animated when it "enters" the browsers viewport (Note: works only in modern browsers).', 'doors' )
);
...
get_template_part('inc/vcomposer/vc_elements/wd_one_post');
get_template_part('inc/vcomposer/vc_elements/wd_count_up');
get_template_part('inc/vcomposer/vc_elements/wd_chart_pie');
get_template_part('inc/vcomposer/vc_elements/wd_hero_image');
get_template_part('inc/vcomposer/vc_elements/wd_featured_box');
get_template_part('inc/vcomposer/vc_elements/wd_flip_image');
get_template_part('inc/vcomposer/vc_elements/wd_modal');
get_template_part('inc/vcomposer/vc_elements/wd_team_member');
get_template_part('inc/vcomposer/vc_elements/wd_team');
get_template_part('inc/vcomposer/vc_elements/wd_testimonial');
get_template_part('inc/vcomposer/vc_elements/wd_image_with_text');
...
vc_map( array(
	"name" => esc_html__("Text Block with Icon", 'doors'),
	"base" => "doors_icon_text",
