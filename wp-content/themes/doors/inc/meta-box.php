...
if ( !class_exists('myCustomFields') ) {
	...
	class myCustomFields {
		...
		*/
		var $postTypes = array( "page", "post", "portfolio", "testimonials", "testimonials", "team-member", "wd-team-member");
		/**
			...
			if ( function_exists( 'add_meta_box' ) ) {
				foreach ( $this->postTypes as $postType ) {
					...
					if($postType == "wd-team-member") {
						add_meta_box( 'my-custom-fields', 'Team Member informations', array( &$this, 'displayCustomFields' ), 'wd-team-member', 'advanced', 'high' );
					}
